...
const ChatFormUser = ({ onSubmitMessage }) => {
    ...
    return (
        <motion.form
            className="w-[50vw] absolute bottom-4 ms-4"
        ...
        >
            <div className="bg-blackPure rounded-3xl px-3">
                <div className="p-inputgroup flex-1">
                    ...
                    <InputTextarea
                        ...
                        className="custom-input-chat h-12 pt-4 pb-4 flex items-center my-auto font-poppins bg-transparent border-none placeholder:text-white text-white text-xs"
