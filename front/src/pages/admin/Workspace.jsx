...
import ChatForm from "../../components/admin/ChatForm"
import MessageBlock from "../../components/admin/MessageBlock"
            ...
            >
                ...
                <main
                    className={`${collapsed ? "ms-24" : "ms-64"
                        } me-12 mt-7 pb-8 bg-blackPure grid grid-cols-[30%_70%] space-x-6`}
                >
